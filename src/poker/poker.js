...
Table.prototype.getPot = function () {
    return this.game.pot;
};
Table.prototype.getRoundName = function () {
...
Table.prototype.getPlayerFromName = function (playerName) {
    for (i = 0; i < this.players.length; i += 1) {
        if (playerName == this.players[i].playerName) {
